...
3. **Schrittweise Umsetzung entlang der Entscheidungsreihenfolge:** zuerst Datenmodell und Migrations-Logik (D20/D43), dann die Sequenzansicht selbst (D3/D10/D11), dann Vorschlagsmechanik und Dramaturgie-Check (D14/D15/D22/D23/D40/D41), zuletzt Bibliothek und Einreichen-Workflow (D28–D33, D37–D39). Nach jedem Block: Test auf Staging, bevor der nächste Block beginnt.

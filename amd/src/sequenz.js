...
function(Ajax, UserRepository, Fragment, Templates) {
    ...
    class SequenzView {
        ...
        // Der Differenzierer als Modal: onAccept(sentence, phase) wird mit dem
        // fertigen „Ich kann …"-Satz und der abgeleiteten Seminarphase gerufen.
        openLernzielEditor(onAccept) {
            ...
            overlay.addEventListener('click', (event) => {
                ...
                if (type === 'close') {
                    ...
                    if (isComplete() && accept) {
                        accept(plainSentence(), diffPhaseForVerb(state.denken));
                    }
                    this.closeLernzielEditor();
                }
            });

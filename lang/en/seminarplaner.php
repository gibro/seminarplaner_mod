...
$string['method_subnav_create'] = 'Create';
$string['method_subnav_library'] = 'Library';
$string['ueberblick_subline'] = 'The complete seminar plan at a glance - read-only.';
$string['ueberblick_readonlynote'] = 'This overview shows your complete plan - editing happens in the "Sequence" tab. Click a seminar unit to change it there.';
$string['ueberblick_tosequenz'] = 'Switch to sequence';
$string['sequenz_dramatoggle'] = 'Didactic recommendations';
$string['sequenz_dramatoggle_info'] = 'Checks the displayed day against didactic rules of thumb - morning opening, activation after lunch, varied social forms, breaks and closing - and shows hints below the day plan. Recommendations only: nothing in the plan changes automatically.';

...
$string['ueberblick_readonlynote'] = 'The overview shows all days side by side - for viewing and printing. Planning and changes happen in the "Sequence" tab. Click a seminar unit to change it in the sequence view.';

...
$string['sequenz_dramatoggle_info'] = 'Checks the plan against didactic rules of thumb - morning opening, activation after lunch, varied social forms, breaks, closing and time frame - and shows hints below the day plan. Recommendations only: nothing in the plan changes automatically.';
